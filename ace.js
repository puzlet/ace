...
(function() {
  var Ace, CodeNodeComment, CodeNodeFunction, CodeNodeGistLink, CoffeeEditor, CoffeeEval, _ref,
    ...
    CustomRenderer.prototype.render = function() {
      ...
      this.gists = (function() {
        ...
        for (_k = 0, _len2 = strings.length; _k < _len2; _k++) {
          s = strings[_k];
          if (s.innerHTML.indexOf("gist") === 0) {
            _results.push(new CodeNodeGistLink($(s), linkCallback));
          }
        }
        return _results;
      })();
  ...
  CodeNodeGistLink = (function() {
    ...
    CodeNodeGistLink.prototype.replaceDiv = function() {
      var content, gistId, link, match, re, txt;
      txt = this.originalText;
      re = /^gist:([a-z0-9_-]+)/;
      match = re.exec(txt);
      gistId = match[1];
    ...
    CodeNodeGistLink.prototype.mathJax = function() {
      var node;
      if (!(node = this.node[0])) {
        return;
      }
